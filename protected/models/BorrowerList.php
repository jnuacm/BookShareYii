...
/**
 * This is the model class for table "tbl_borrower_list".
 *
 * The followings are the available columns in table 'tbl_borrower_list':
 * @property integer $id
 ...
 * @property Book $book
 */
class BorrowerList extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('borrow_time, return_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, book_id, borrower, borrow_time, return_time', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return BorrowerList the static model class
	 */
