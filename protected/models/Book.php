...
class Book extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'tblUsers' => array(self::MANY_MANY, 'User', 'tbl_book_user_own(book_id, owner_id)'),
		);
	}
